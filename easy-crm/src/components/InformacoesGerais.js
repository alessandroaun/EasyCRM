...
const styles = StyleSheet.create({
  ...
  navExportBtn: {
    ...
    paddingHorizontal: 14,
    borderRadius: 8,
    ...Platform.select({ web: { cursor: 'pointer', transition: 'all 0.15s ease', boxShadow: '0 2px 6px rgba(37, 99, 235, 0.25)' } })
  },
  navExportBtnText: {
    fontFamily: MODERN_FONT,
    color: '#ffffff',
  ...
  pageSubtitle: { fontFamily: MODERN_FONT, fontSize: 13, marginTop: 3, fontWeight: '500' },

  toolsContainer: { marginBottom: 20, padding: 18, borderRadius: 16, borderWidth: 1, ...Platform.select({ web: { boxShadow: '0 2px 6px rgba(0,0,0,0.02)' } }) },
  ...
  filterGroupLabel: { fontFamily: MODERN_FONT, fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 0.5 },
  filterButtonGroup: { flexDirection: 'row', borderRadius: 10, padding: 3 },
  filterButtonGroupMobile: { flexWrap: 'wrap', width: '100%', gap: 4 },
  filterBtn: { paddingVertical: 6, paddingHorizontal: 14, borderRadius: 8, ...Platform.select({ web: { cursor: 'pointer', transition: 'all 0.15s ease' } }) },
  filterText: { fontFamily: MODERN_FONT, fontSize: 12, fontWeight: '600' },
  ...
  pickerLabel: { fontFamily: MODERN_FONT, fontSize: 10, fontWeight: '700', marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.3 },
  webSelect: { width: '100%', paddingVertical: 7, paddingHorizontal: 10, borderRadius: 8, borderWidth: 1, fontSize: 12, fontFamily: MODERN_FONT, outlineStyle: 'none' },
  pickerFallback: { fontFamily: MODERN_FONT, fontSize: 11, color: '#94a3b8' },

  customDateWrapper: { flexDirection: 'row', gap: 12, marginTop: 14, paddingTop: 14, borderTopWidth: 1 },
  customDateWrapperMobile: { flexDirection: 'column', gap: 12 },
  customDateInputBox: { width: 130 },
  customDateInputBoxMobile: { width: '100%' },
  customDateLabel: { fontFamily: MODERN_FONT, fontSize: 10, fontWeight: '800', marginBottom: 4, textTransform: 'uppercase' },
  customDateInput: { borderWidth: 1, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 7, fontSize: 12, fontFamily: MODERN_FONT },
  ...
  kpiCard: { 
    ...
    padding: 20, 
    borderWidth: 1,
    ...Platform.select({ web: { boxShadow: '0 2px 8px rgba(0,0,0,0.03)', transition: 'transform 0.15s ease' } })
  },
  kpiCardMobile: { flexBasis: '45%', flexGrow: 1, minWidth: 140 },
  kpiTitle: { fontFamily: MODERN_FONT, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 6 },
  kpiValue: { fontFamily: MODERN_FONT, fontSize: 26, fontWeight: '800', letterSpacing: -0.5 },

  mainLayout: { flexDirection: 'row', gap: 20 },
  mainLayoutMobile: { flexDirection: 'column', gap: 16 },
  leftColumn: { gap: 20 },
  rightColumn: { gap: 20 },

  dashboardCard: { borderRadius: 16, padding: 22, borderWidth: 1, ...Platform.select({ web: { boxShadow: '0 2px 8px rgba(0,0,0,0.03)' } }) },
  cardHeader: { fontFamily: MODERN_FONT, fontSize: 15, fontWeight: '800', letterSpacing: -0.3, marginBottom: 16 },
  
  barContainer: { marginBottom: 14 },
  barHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 6, alignItems: 'flex-end' },
  barLabel: { fontFamily: MODERN_FONT, fontSize: 12, fontWeight: '700' },
  barValue: { fontFamily: MODERN_FONT, fontSize: 12, fontWeight: '800' },
  barTrack: { height: 10, borderRadius: 5, overflow: 'hidden' },
  barFill: { height: '100%', borderRadius: 5 },

  effortGrid: { flexDirection: 'row', gap: 12, marginBottom: 16 },
  effortGridMobile: { flexDirection: 'column' },
  effortBox: { flex: 1, padding: 16, borderRadius: 12, borderWidth: 1, alignItems: 'center' },
  effortLabel: { fontFamily: MODERN_FONT, fontSize: 11, fontWeight: '700', textAlign: 'center', marginBottom: 4, textTransform: 'uppercase' },
  effortNumber: { fontFamily: MODERN_FONT, fontSize: 24, fontWeight: '800' },
  
  infoBalloon: { flexDirection: 'row', padding: 12, borderRadius: 10, borderWidth: 1, alignItems: 'center', gap: 10 },
  infoIconBox: { width: 22, height: 22, borderRadius: 11, backgroundColor: '#2563eb', justifyContent: 'center', alignItems: 'center' },
  infoIconText: { color: '#ffffff', fontSize: 12, fontWeight: 'bold', fontFamily: MODERN_FONT },
  infoBalloonText: { fontFamily: MODERN_FONT, fontSize: 12, lineHeight: 18, flex: 1 },

  financialTotalValue: { fontFamily: MODERN_FONT, fontSize: 28, fontWeight: '800', letterSpacing: -0.5, marginBottom: 16, color: '#38bdf8' },
  financialList: { gap: 8 },
  finItem: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 8, borderBottomWidth: 1 },
  finLabel: { fontFamily: MODERN_FONT, fontSize: 12, fontWeight: '600' },
  finValue: { fontFamily: MODERN_FONT, fontSize: 12, fontWeight: '700' },

  axisGraphContainer: { height: 180, borderRadius: 12, borderWidth: 1, padding: 12, position: 'relative' },
  axisYContainer: { position: 'absolute', left: 0, top: 0, bottom: 0, width: 75, paddingVertical: 12, paddingLeft: 8, justifyContent: 'space-between', borderRightWidth: 1 },
  axisLabel: { fontFamily: MODERN_FONT, fontSize: 10, fontWeight: '700' },
  gridLine: { position: 'absolute', left: 75, right: 0, height: 1 },
  
  timelineBarsWrapper: { flexDirection: 'row', height: 150, alignItems: 'flex-end', justifyContent: 'space-around', paddingTop: 10 },
  timelineBarCol: { alignItems: 'center', flex: 1, height: '100%', justifyContent: 'flex-end' },
  timelineBarFill: { width: 22, backgroundColor: '#3b82f6', borderTopLeftRadius: 6, borderTopRightRadius: 6 },
  timelineBarText: { fontFamily: MODERN_FONT, fontSize: 10, fontWeight: '600', marginTop: 6 },
  emptyGraphText: { fontFamily: MODERN_FONT, fontSize: 12, textAlign: 'center', marginVertical: 30, fontStyle: 'italic' },

  adminSectionWrapper: { marginTop: 36, paddingTop: 24, borderTopWidth: 1 },
  adminSectionHeader: { marginBottom: 20 },
  adminSectionTitle: { fontFamily: MODERN_FONT, fontSize: 18, fontWeight: '800', letterSpacing: -0.3 },
  adminSectionSubtitle: { fontFamily: MODERN_FONT, fontSize: 13, marginTop: 4, fontWeight: '500' },
  adminModulesGrid: { flexDirection: 'row', gap: 16 },
  adminModulesGridMobile: { flexDirection: 'column' },
  dashModule: { flex: 1, borderRadius: 14, padding: 18, borderWidth: 1 },
  dashModuleHighlight: { flex: 1, borderRadius: 14, padding: 18, borderWidth: 1 },
  dashModuleTitle: { fontFamily: MODERN_FONT, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.3, marginBottom: 8 },
  moduleBigNum: { fontFamily: MODERN_FONT, fontSize: 24, fontWeight: '800', letterSpacing: -0.5 },
  moduleSmallDesc: { fontFamily: MODERN_FONT, fontSize: 12, fontWeight: '500', marginBottom: 12 },
  moduleDesc: { fontFamily: MODERN_FONT, fontSize: 12, lineHeight: 18, fontWeight: '500' },
  
  rankBarsList: { gap: 10, marginTop: 8 },
  rankBarContainer: { gap: 4 },
  rankBarHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  rankBarLabel: { fontFamily: MODERN_FONT, fontSize: 11, fontWeight: '600' },
  rankBarValue: { fontFamily: MODERN_FONT, fontSize: 11, fontWeight: '800' },
  ...
  moduleEmptyText: { fontFamily: MODERN_FONT, fontSize: 13, fontWeight: '800', marginBottom: 4 },
  ...
  historyModalContainer: { width: '100%', maxWidth: 640, borderRadius: 20, padding: 24, maxHeight: '85%', ...Platform.select({ web: { boxShadow: '0 20px 40px rgba(0,0,0,0.3)' } }) },
  historyModalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
  historyModalTitle: { fontSize: 18, fontWeight: '800', fontFamily: MODERN_FONT, flexShrink: 1, marginRight: 10, letterSpacing: -0.3 },
  closeButton: { padding: 4 },
  closeButtonText: { fontSize: 20, fontWeight: 'bold' },
  historyModalContent: { flex: 1 },
  emptyText: { textAlign: 'center', fontStyle: 'italic', marginTop: 40, fontFamily: MODERN_FONT, fontSize: 13 },

  historyCard: { borderWidth: 1, borderRadius: 10, padding: 14, marginBottom: 10 },
  historyHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 6 },
  historyStatus: { fontWeight: '700', fontSize: 12, fontFamily: MODERN_FONT },
  historyDate: { fontSize: 11, fontFamily: MODERN_FONT },
  historyMsg: { fontSize: 13, marginBottom: 6, fontFamily: MODERN_FONT, lineHeight: 18 },
  historyMsgClean: { fontSize: 12, padding: 8, borderRadius: 6, borderWidth: 1, fontStyle: 'italic', marginTop: 4, fontFamily: MODERN_FONT },
  historyItalicHint: { fontSize: 10, fontStyle: 'italic', textAlign: 'right', flex: 1 },
  historyStatsRow: { flexDirection: 'row', justifyContent: 'space-between', borderTopWidth: 1, paddingTop: 8, marginTop: 6 },
  historyStatItem: { fontSize: 11, fontWeight: '600', fontFamily: MODERN_FONT }
});
...
const lightStyles = StyleSheet.create({
  ...
  adminNavbar: { backgroundColor: TOKENS.light.surface, borderColor: TOKENS.light.border },
  adminNavSelect: { color: TOKENS.light.textPrimary },
  navDivider: { backgroundColor: TOKENS.light.border },
  navHistoryBtnText: { color: TOKENS.light.textSecondary },

  toolsContainer: { backgroundColor: TOKENS.light.surface, borderColor: TOKENS.light.border },
  filterGroupLabel: { color: TOKENS.light.textSecondary },
  filterButtonGroup: { backgroundColor: TOKENS.light.surfaceSubtle, borderWidth: 1, borderColor: TOKENS.light.border },
  filterBtnActive: { backgroundColor: TOKENS.light.surface, ...TOKENS.light.cardShadow },
  filterText: { color: TOKENS.light.textMuted },
  filterTextActive: { color: TOKENS.light.primary, fontWeight: '700' },
  pickerLabel: { color: TOKENS.light.textSecondary },
  webSelect: { borderColor: TOKENS.light.border, backgroundColor: TOKENS.light.surfaceSubtle, color: TOKENS.light.textPrimary },
  customDateWrapper: { borderTopColor: TOKENS.light.borderSubtle },
  customDateLabel: { color: TOKENS.light.textSecondary },
  customDateInput: { backgroundColor: TOKENS.light.surfaceSubtle, borderColor: TOKENS.light.border, color: TOKENS.light.textPrimary },
  kpiCard: { backgroundColor: TOKENS.light.surface, borderColor: TOKENS.light.border },
  kpiTitle: { color: TOKENS.light.textMuted },
  kpiValue: { color: TOKENS.light.textPrimary },
  dashboardCard: { backgroundColor: TOKENS.light.surface, borderColor: TOKENS.light.border },
  cardHeader: { color: TOKENS.light.textPrimary },
  barLabel: { color: TOKENS.light.textPrimary },
  barValue: { color: TOKENS.light.textSecondary },
  barTrack: { backgroundColor: TOKENS.light.surfaceSubtle },
  effortBox: { backgroundColor: TOKENS.light.surfaceSubtle, borderColor: TOKENS.light.border },
  effortLabel: { color: TOKENS.light.textSecondary },
  effortNumber: { color: TOKENS.light.success },
  infoBalloon: { backgroundColor: TOKENS.light.infoSubtle, borderColor: TOKENS.light.infoBorder },
  infoBalloonText: { color: '#0369a1' },
  finItem: { borderBottomColor: TOKENS.light.borderSubtle },
  finLabel: { color: TOKENS.light.textSecondary },
  finValue: { color: TOKENS.light.textPrimary },
  axisGraphContainer: { backgroundColor: TOKENS.light.surfaceSubtle, borderColor: TOKENS.light.border },
  axisYContainer: { backgroundColor: TOKENS.light.surface, borderRightColor: TOKENS.light.border },
  axisLabel: { color: TOKENS.light.textMuted },
  gridLine: { backgroundColor: TOKENS.light.border },
  timelineBarText: { color: TOKENS.light.textMuted },
  emptyGraphText: { color: TOKENS.light.textMuted },

  adminSectionWrapper: { borderTopColor: TOKENS.light.border },
  adminSectionTitle: { color: TOKENS.light.textPrimary },
  adminSectionSubtitle: { color: TOKENS.light.textSecondary },
  dashModule: { backgroundColor: TOKENS.light.surface, borderColor: TOKENS.light.border },
  dashModuleHighlight: { borderColor: TOKENS.light.dangerBorder, backgroundColor: TOKENS.light.dangerSubtle },
  dashModuleTitle: { color: TOKENS.light.textPrimary },
  moduleBigNum: { color: TOKENS.light.textPrimary },
  moduleSmallDesc: { color: TOKENS.light.textSecondary },
  moduleDesc: { color: TOKENS.light.textSecondary },
  rankBarLabel: { color: TOKENS.light.textSecondary },
  rankBarValue: { color: TOKENS.light.textPrimary },
  rankBarTrack: { backgroundColor: TOKENS.light.surfaceSubtle },
  moduleEmptyText: { color: TOKENS.light.textPrimary },
  moduleEmptySub: { color: TOKENS.light.textMuted },

  historyModalContainer: { backgroundColor: TOKENS.light.surface },
  historyModalTitle: { color: TOKENS.light.textPrimary },
  closeButtonText: { color: TOKENS.light.textMuted },
  emptyText: { color: TOKENS.light.textMuted },
  historyCard: { backgroundColor: TOKENS.light.surfaceSubtle, borderColor: TOKENS.light.border },
  historyDate: { color: TOKENS.light.textMuted },
  historyMsg: { color: TOKENS.light.textPrimary },
  historyMsgClean: { backgroundColor: TOKENS.light.surface, borderColor: TOKENS.light.border, color: TOKENS.light.textSecondary },
  historyItalicHint: { color: TOKENS.light.textMuted },
  historyStatsRow: { borderTopColor: TOKENS.light.border },
  historyStatItem: { color: TOKENS.light.textSecondary }
});
...
const darkStyles = StyleSheet.create({
  ...
  adminNavbar: { backgroundColor: TOKENS.dark.surface, borderColor: TOKENS.dark.border },
  adminNavSelect: { color: TOKENS.dark.textPrimary },
  navDivider: { backgroundColor: TOKENS.dark.border },
  navHistoryBtnText: { color: TOKENS.dark.textSecondary },

  toolsContainer: { backgroundColor: TOKENS.dark.surface, borderColor: TOKENS.dark.border },
  filterGroupLabel: { color: TOKENS.dark.textSecondary },
  filterButtonGroup: { backgroundColor: TOKENS.dark.surfaceSubtle, borderWidth: 1, borderColor: TOKENS.dark.border },
  filterBtnActive: { backgroundColor: TOKENS.dark.surfaceHover, ...TOKENS.dark.cardShadow },
  filterText: { color: TOKENS.dark.textMuted },
  filterTextActive: { color: '#ffffff', fontWeight: '700' },
  pickerLabel: { color: TOKENS.dark.textSecondary },
  webSelect: { borderColor: TOKENS.dark.border, backgroundColor: TOKENS.dark.surfaceSubtle, color: TOKENS.dark.textPrimary },
  customDateWrapper: { borderTopColor: TOKENS.dark.borderSubtle },
  customDateLabel: { color: TOKENS.dark.textSecondary },
  customDateInput: { backgroundColor: TOKENS.dark.surfaceSubtle, borderColor: TOKENS.dark.border, color: TOKENS.dark.textPrimary },
  kpiCard: { backgroundColor: TOKENS.dark.surface, borderColor: TOKENS.dark.border },
  kpiTitle: { color: TOKENS.dark.textMuted },
  kpiValue: { color: TOKENS.dark.textPrimary },
  dashboardCard: { backgroundColor: TOKENS.dark.surface, borderColor: TOKENS.dark.border },
  cardHeader: { color: TOKENS.dark.textPrimary },
  barLabel: { color: TOKENS.dark.textPrimary },
  barValue: { color: TOKENS.dark.textSecondary },
  barTrack: { backgroundColor: TOKENS.dark.surfaceSubtle },
  effortBox: { backgroundColor: TOKENS.dark.surfaceSubtle, borderColor: TOKENS.dark.border },
  effortLabel: { color: TOKENS.dark.textSecondary },
  effortNumber: { color: TOKENS.dark.success },
  infoBalloon: { backgroundColor: TOKENS.dark.infoSubtle, borderColor: TOKENS.dark.infoBorder },
  infoBalloonText: { color: '#7dd3fc' },
  finItem: { borderBottomColor: TOKENS.dark.borderSubtle },
  finLabel: { color: TOKENS.dark.textSecondary },
  finValue: { color: TOKENS.dark.textPrimary },
  axisGraphContainer: { backgroundColor: TOKENS.dark.surfaceSubtle, borderColor: TOKENS.dark.border },
  axisYContainer: { backgroundColor: TOKENS.dark.surface, borderRightColor: TOKENS.dark.border },
  axisLabel: { color: TOKENS.dark.textMuted },
  gridLine: { backgroundColor: TOKENS.dark.border },
  timelineBarText: { color: TOKENS.dark.textMuted },
  emptyGraphText: { color: TOKENS.dark.textMuted },

  adminSectionWrapper: { borderTopColor: TOKENS.dark.border },
  adminSectionTitle: { color: TOKENS.dark.textPrimary },
  adminSectionSubtitle: { color: TOKENS.dark.textSecondary },
  dashModule: { backgroundColor: TOKENS.dark.surface, borderColor: TOKENS.dark.border },
  dashModuleHighlight: { borderColor: TOKENS.dark.dangerBorder, backgroundColor: TOKENS.dark.dangerSubtle },
  dashModuleTitle: { color: TOKENS.dark.textPrimary },
  moduleBigNum: { color: TOKENS.dark.textPrimary },
  moduleSmallDesc: { color: TOKENS.dark.textSecondary },
  moduleDesc: { color: TOKENS.dark.textSecondary },
  rankBarLabel: { color: TOKENS.dark.textSecondary },
  rankBarValue: { color: TOKENS.dark.textPrimary },
  rankBarTrack: { backgroundColor: TOKENS.dark.surfaceSubtle },
  moduleEmptyText: { color: TOKENS.dark.textPrimary },
  moduleEmptySub: { color: TOKENS.dark.textMuted },

  historyModalContainer: { backgroundColor: TOKENS.dark.surface },
  historyModalTitle: { color: TOKENS.dark.textPrimary },
  ...
  historyItalicHint: { color: TOKENS.dark.textMuted },
  historyStatsRow: { borderTopColor: TOKENS.dark.border },
