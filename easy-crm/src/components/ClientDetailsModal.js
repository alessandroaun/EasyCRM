                    ...
                    <View style={{ flexDirection: 'row', gap: 10, marginTop: 4 }}>
                      {['Frio', 'Morno', 'Quente'].map(temp => (
                        ...
                        >
                          ...
                          ]}>{temp === 'Quente' ? '🔥 Quente' : temp === 'Morno' ? '⚡ Morno' : '❄️ Frio'}</Text>
                        </TouchableOpacity>
                      ))}
                    </View>
                  </View>
...
const styles = StyleSheet.create({
  ...
  closeButtonText: { fontFamily: MODERN_FONT, fontSize: 16, fontWeight: 'bold' },
  dealToggleBtn: { 
    paddingVertical: 7, 
  ...
  dealToggleBtnClosed: { borderColor: '#059669', backgroundColor: '#ecfdf5' },
  dealToggleBtnText: { fontFamily: MODERN_FONT, fontWeight: '700', fontSize: 13, color: '#059669' },
  ...
  tabText: { fontFamily: MODERN_FONT, fontSize: 13, fontWeight: '600' },
  tabTextDisabled: { color: '#94a3b8' },
  
  sidebarMobileContainer: { borderBottomWidth: 1 },
  sidebarMobile: { paddingHorizontal: 14, paddingVertical: 8, flexDirection: 'row' },
  tabButtonMobile: { marginRight: 8, marginBottom: 0, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 10, alignItems: 'center' },
  tabTextMobile: { fontFamily: MODERN_FONT, fontSize: 12, fontWeight: '600' },
  
  contentArea: { flex: 1, padding: 28 },
  contentAreaMobile: { padding: 16 },
  formSection: { paddingBottom: 24 },
  sectionTitle: { fontFamily: MODERN_FONT, fontSize: 18, fontWeight: '800', letterSpacing: -0.3, marginBottom: 18 },
  ...
  label: { fontFamily: MODERN_FONT, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.4, marginBottom: 6 },
  input: { 
    borderWidth: 1, 
    borderRadius: 10, 
  ...
  contractContainerCompact: { flex: 1, padding: 10, borderRadius: 8, borderWidth: 1 },
  checkboxContainerCompact: { flexDirection: 'row', alignItems: 'center', marginTop: 2 },

  pdfNoticeText: { fontFamily: MODERN_FONT, textAlign: 'center', fontSize: 11, fontStyle: 'italic', marginTop: 6 },

  pickerContainer: { borderWidth: 1, borderRadius: 8, padding: 4, minHeight: 38, justifyContent: 'center' },
  dropdownItem: { paddingVertical: 8, paddingHorizontal: 10, borderRadius: 6, marginBottom: 2 },
  dropdownItemActive: { backgroundColor: '#2563eb' },
  dropdownItemText: { fontFamily: MODERN_FONT, fontSize: 12, fontWeight: '600' },
  ...
  apptTypeContainerHorizontal: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 14 },
  apptTypeBtnHorizontal: { paddingVertical: 6, paddingHorizontal: 12, borderRadius: 8, borderWidth: 1, minWidth: 65, alignItems: 'center', ...Platform.select({ web: { cursor: 'pointer', transition: 'all 0.15s ease' } }) },
  apptTypeText: { fontFamily: MODERN_FONT, fontWeight: '700', fontSize: 11 },
  saveApptBtn: { backgroundColor: '#f59e0b', paddingVertical: 10, borderRadius: 10, alignItems: 'center', marginTop: 10, marginBottom: 4, ...Platform.select({ web: { cursor: 'pointer', transition: 'all 0.15s ease' } }) },
  saveApptBtnText: { fontFamily: MODERN_FONT, color: '#ffffff', fontWeight: '800', fontSize: 12 },
  deleteApptBtn: { padding: 6, borderRadius: 6, ...Platform.select({ web: { cursor: 'pointer' } }) },
  ...
  scheduledCard: { 
    ...
    padding: 14, 
    marginBottom: 10, 
    ...Platform.select({ web: { boxShadow: '0 2px 6px rgba(0,0,0,0.03)' } }) 
  },
  scheduledCardDone: { opacity: 0.5, borderLeftColor: '#cbd5e1' },
  scheduledCardTitle: { fontFamily: MODERN_FONT, fontSize: 13, fontWeight: '800' },
  scheduledCardReminder: { fontFamily: MODERN_FONT, fontSize: 10, fontWeight: '800', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 },
  scheduledCardDate: { fontFamily: MODERN_FONT, fontSize: 11, marginTop: 4, fontWeight: '600' },
  scheduledCardStatus: { fontFamily: MODERN_FONT, fontSize: 10, color: '#059669', marginTop: 6, fontWeight: '800' },

  statusBtnGroup: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 24 },
  clientStatusBtn: { paddingVertical: 10, paddingHorizontal: 16, borderRadius: 10, borderWidth: 1, ...Platform.select({ web: { cursor: 'pointer', transition: 'all 0.15s ease' } }) },
  clientStatusBtnActive: { backgroundColor: '#2563eb', borderColor: '#1d4ed8' },
  clientStatusBtnText: { fontFamily: MODERN_FONT, fontSize: 12, fontWeight: '700' },
  clientStatusBtnTextActive: { color: '#ffffff', fontWeight: '800' },
  clientStatusBtnTextInactive: { fontWeight: '600' },
   
  contractContainer: { padding: 18, borderRadius: 14, borderWidth: 1, marginBottom: 20 },
  contractTitle: { fontFamily: MODERN_FONT, fontSize: 15, fontWeight: '800', letterSpacing: -0.2, marginBottom: 16 },
  addContractBtn: { paddingVertical: 12, borderRadius: 10, borderWidth: 1.5, borderStyle: 'dashed', borderColor: '#2563eb', alignItems: 'center', ...Platform.select({ web: { cursor: 'pointer' } }) },
  addContractBtnText: { fontFamily: MODERN_FONT, color: '#2563eb', fontWeight: '800', fontSize: 13 },
   
  installmentsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 10 },
  installmentBox: { width: 42, height: 42, borderRadius: 8, borderWidth: 1, justifyContent: 'center', alignItems: 'center', ...Platform.select({ web: { cursor: 'pointer', transition: 'all 0.15s ease' } }) },
  installmentBoxChecked: { backgroundColor: '#059669', borderColor: '#047857' },
  installmentText: { fontFamily: MODERN_FONT, fontSize: 12, fontWeight: '800' },
  installmentTextChecked: { color: '#ffffff' },

  commentsSidebarDesktop: { width: 350, borderLeftWidth: 1, padding: 20, paddingBottom: 0 },
  commentsContainer: { flex: 1 },
  commentsContainerMobile: { paddingBottom: 20 },
  commentsTitle: { fontFamily: MODERN_FONT, fontSize: 15, fontWeight: '800', letterSpacing: -0.2, marginBottom: 14 },
  commentInputContainer: { padding: 12, borderRadius: 12, borderWidth: 1, marginBottom: 16 },
  commentInput: { height: 65, textAlignVertical: 'top', fontSize: 13, fontFamily: MODERN_FONT, marginBottom: 10, ...Platform.select({ web: { outlineStyle: 'none' } }) },
  addCommentBtn: { alignSelf: 'flex-end', backgroundColor: '#059669', paddingVertical: 7, paddingHorizontal: 16, borderRadius: 8, ...Platform.select({ web: { cursor: 'pointer', transition: 'all 0.15s ease' } }) },
  addCommentBtnText: { fontFamily: MODERN_FONT, color: '#ffffff', fontWeight: '700', fontSize: 12 },
  commentsList: { flex: 1 },
  noCommentsText: { fontFamily: MODERN_FONT, fontStyle: 'italic', textAlign: 'center', marginTop: 24, fontSize: 12 },
  commentCard: { padding: 14, borderRadius: 12, borderWidth: 1, marginBottom: 12 },
  commentDate: { fontFamily: MODERN_FONT, fontSize: 10, marginBottom: 6, fontWeight: '700' },
  commentTextManual: { fontFamily: MODERN_FONT, fontSize: 13, lineHeight: 19, fontWeight: '500' },
  commentTextAuto: { fontFamily: MODERN_FONT, fontSize: 12, lineHeight: 18, fontStyle: 'italic' },

  footer: { flexDirection: 'row', justifyContent: 'flex-end', paddingHorizontal: 28, paddingVertical: 18, borderTopWidth: 1, gap: 12 },
  footerMobile: { padding: 16 },
  cancelButton: { paddingVertical: 10, paddingHorizontal: 20, borderRadius: 10, ...Platform.select({ web: { cursor: 'pointer', transition: 'all 0.15s ease' } }) },
  ...
  successAlertOverlay: { position: 'absolute', top: 0, bottom: 0, left: 0, right: 0, backgroundColor: 'rgba(15, 23, 42, 0.6)', justifyContent: 'center', alignItems: 'center', zIndex: 9999 },
  successAlertBox: { padding: 28, borderRadius: 20, alignItems: 'center', width: 340, ...Platform.select({ web: { boxShadow: '0 20px 40px rgba(0,0,0,0.3)' } }) },
  successAlertIcon: { fontSize: 44, marginBottom: 12 },
  successAlertTitle: { fontFamily: MODERN_FONT, fontSize: 18, fontWeight: '800', letterSpacing: -0.3, marginBottom: 8 },
  ...
  checkbox: { width: 18, height: 18, borderWidth: 1.5, borderRadius: 5, marginRight: 8, justifyContent: 'center', alignItems: 'center' },
  checkboxChecked: { backgroundColor: '#2563eb', borderColor: '#2563eb' },
  checkmark: { color: '#ffffff', fontSize: 11, fontWeight: 'bold' },
  checkboxLabel: { fontFamily: MODERN_FONT, fontSize: 12, fontWeight: '500', flex: 1, flexWrap: 'wrap' },
  ...
  tempBtnText: { fontFamily: MODERN_FONT, fontSize: 12, fontWeight: '700' },
  probContainer: { marginTop: 24, padding: 18, borderRadius: 14, borderWidth: 1 },
  probHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  probPercentage: { fontFamily: MODERN_FONT, fontSize: 28, fontWeight: '900', letterSpacing: -0.5 },
  probJustification: { fontFamily: MODERN_FONT, fontSize: 12, lineHeight: 18, marginBottom: 16, fontWeight: '500' },
  probDisclaimerBox: { backgroundColor: 'rgba(245, 158, 11, 0.08)', padding: 12, borderRadius: 8, borderLeftWidth: 3, borderLeftColor: '#f59e0b' },
  probDisclaimerText: { fontFamily: MODERN_FONT, fontSize: 11, color: '#b45309', fontStyle: 'italic', lineHeight: 16 },
});

const lightStyles = StyleSheet.create({
  modalWrapper: { backgroundColor: TOKENS.light.surface },
  header: { borderBottomColor: TOKENS.light.borderSubtle },
  title: { color: TOKENS.light.textPrimary },
  subtitle: { color: TOKENS.light.textMuted },
  closeButton: { backgroundColor: TOKENS.light.surfaceSubtle },
  closeButtonText: { color: TOKENS.light.textSecondary },
  body: { backgroundColor: TOKENS.light.surface },
  sidebar: { backgroundColor: TOKENS.light.surfaceSubtle, borderRightColor: TOKENS.light.borderSubtle },
  tabButton: { backgroundColor: 'transparent', borderColor: 'transparent' },
  tabButtonActive: { backgroundColor: TOKENS.light.surface, borderColor: TOKENS.light.border, ...TOKENS.light.cardShadow },
  tabText: { color: TOKENS.light.textSecondary },
  tabTextActive: { color: TOKENS.light.primary, fontWeight: '800' },
  sidebarMobileContainer: { borderBottomColor: TOKENS.light.borderSubtle, backgroundColor: TOKENS.light.surfaceSubtle },
  tabButtonMobile: { backgroundColor: TOKENS.light.surface, borderColor: TOKENS.light.border },
  tabButtonMobileActive: { backgroundColor: TOKENS.light.primary },
  tabTextMobile: { color: TOKENS.light.textSecondary },
  tabTextMobileActive: { color: '#ffffff' },
  contentArea: { backgroundColor: TOKENS.light.surface },
  ...
  inputSmall: { backgroundColor: TOKENS.light.surfaceSubtle, borderColor: TOKENS.light.border, color: TOKENS.light.textPrimary },
  pickerContainer: { backgroundColor: TOKENS.light.surfaceSubtle, borderColor: TOKENS.light.border },
  dropdownItemText: { color: TOKENS.light.textPrimary },
  splitRight: { borderColor: TOKENS.light.borderSubtle },
  apptTypeBtn: { backgroundColor: TOKENS.light.surfaceSubtle, borderColor: TOKENS.light.border },
  apptTypeBtnActive: { backgroundColor: '#eff6ff', borderColor: '#3b82f6' },
  apptTypeText: { color: TOKENS.light.textSecondary },
  apptTypeTextActive: { color: '#1d4ed8' },
  deleteApptBtn: { backgroundColor: TOKENS.light.dangerSubtle },
  scheduledCard: { backgroundColor: TOKENS.light.surface, borderColor: TOKENS.light.border },
  scheduledCardDone: { backgroundColor: TOKENS.light.surfaceSubtle },
  scheduledCardTitle: { color: TOKENS.light.textPrimary },
  scheduledCardReminder: { color: '#b45309', backgroundColor: '#fef3c7' },
  scheduledCardDate: { color: TOKENS.light.textSecondary },
  clientStatusBtnInactive: { backgroundColor: TOKENS.light.surfaceSubtle, borderColor: TOKENS.light.border },
  clientStatusBtnTextInactive: { color: TOKENS.light.textSecondary },
  contractContainer: { backgroundColor: TOKENS.light.surfaceSubtle, borderColor: TOKENS.light.border },
  contractTitle: { color: TOKENS.light.textPrimary },
  installmentBox: { backgroundColor: TOKENS.light.surface, borderColor: TOKENS.light.border },
  commentsSidebarDesktop: { backgroundColor: TOKENS.light.surfaceSubtle, borderLeftColor: TOKENS.light.borderSubtle },
  commentsTitle: { color: TOKENS.light.textPrimary },
  commentInputContainer: { backgroundColor: TOKENS.light.surface, borderColor: TOKENS.light.border },
  commentInput: { color: TOKENS.light.textPrimary },
  noCommentsText: { color: TOKENS.light.textMuted },
  commentDate: { color: TOKENS.light.textMuted },
  commentCardManual: { backgroundColor: TOKENS.light.surface, borderColor: '#bfdbfe', borderLeftColor: '#2563eb', borderLeftWidth: 4 },
  commentTextManual: { color: TOKENS.light.textPrimary },
  commentCardAuto: { backgroundColor: TOKENS.light.surface, borderColor: TOKENS.light.borderSubtle, borderLeftColor: TOKENS.light.border, borderLeftWidth: 4 },
  commentTextAuto: { color: TOKENS.light.textSecondary },
  footer: { borderTopColor: TOKENS.light.borderSubtle, backgroundColor: TOKENS.light.surface },
  ...
  checkbox: { borderColor: TOKENS.light.border, backgroundColor: TOKENS.light.surface },
  checkboxLabel: { color: TOKENS.light.textPrimary },
  pdfNoticeText: { color: TOKENS.light.textMuted },

  tempBtnInactive: { backgroundColor: TOKENS.light.surfaceSubtle, borderColor: TOKENS.light.border },
  tempBtnTextInactive: { color: TOKENS.light.textSecondary },
  probContainer: { backgroundColor: TOKENS.light.surfaceSubtle, borderColor: TOKENS.light.border },
  probJustification: { color: TOKENS.light.textSecondary },
});

const darkStyles = StyleSheet.create({
  modalWrapper: { backgroundColor: TOKENS.dark.surface },
  header: { borderBottomColor: TOKENS.dark.borderSubtle },
  title: { color: TOKENS.dark.textPrimary },
  subtitle: { color: TOKENS.dark.textMuted },
  closeButton: { backgroundColor: TOKENS.dark.surfaceSubtle },
  closeButtonText: { color: TOKENS.dark.textSecondary },
  body: { backgroundColor: TOKENS.dark.surface },
  sidebar: { backgroundColor: TOKENS.dark.surfaceSubtle, borderRightColor: TOKENS.dark.borderSubtle },
  tabButton: { backgroundColor: 'transparent', borderColor: 'transparent' },
  tabButtonActive: { backgroundColor: TOKENS.dark.surface, borderColor: TOKENS.dark.border, ...TOKENS.dark.cardShadow },
  tabText: { color: TOKENS.dark.textSecondary },
  tabTextActive: { color: '#60a5fa', fontWeight: '800' },
  sidebarMobileContainer: { borderBottomColor: TOKENS.dark.borderSubtle, backgroundColor: TOKENS.dark.surfaceSubtle },
  tabButtonMobile: { backgroundColor: TOKENS.dark.surface, borderColor: TOKENS.dark.border },
  tabButtonMobileActive: { backgroundColor: '#2563eb' },
  tabTextMobile: { color: TOKENS.dark.textSecondary },
  tabTextMobileActive: { color: '#ffffff' },
  contentArea: { backgroundColor: TOKENS.dark.surface },
  ...
  inputSmall: { backgroundColor: TOKENS.dark.surfaceSubtle, borderColor: TOKENS.dark.border, color: TOKENS.dark.textPrimary },
  ...
  splitRight: { borderColor: TOKENS.dark.borderSubtle },
  apptTypeBtn: { backgroundColor: TOKENS.dark.surfaceSubtle, borderColor: TOKENS.dark.border },
  apptTypeBtnActive: { backgroundColor: '#1e3a8a', borderColor: '#3b82f6' },
  apptTypeText: { color: TOKENS.dark.textSecondary },
  apptTypeTextActive: { color: '#93c5fd' },
  deleteApptBtn: { backgroundColor: TOKENS.dark.dangerSubtle },
  scheduledCard: { backgroundColor: TOKENS.dark.surface, borderColor: TOKENS.dark.border },
  scheduledCardDone: { backgroundColor: TOKENS.dark.surfaceSubtle },
  scheduledCardTitle: { color: TOKENS.dark.textPrimary },
  scheduledCardReminder: { color: '#fbbf24', backgroundColor: '#451a03' },
  scheduledCardDate: { color: TOKENS.dark.textSecondary },
  clientStatusBtnInactive: { backgroundColor: TOKENS.dark.surfaceSubtle, borderColor: TOKENS.dark.border },
  clientStatusBtnTextInactive: { color: TOKENS.dark.textSecondary },
  contractContainer: { backgroundColor: TOKENS.dark.surfaceSubtle, borderColor: TOKENS.dark.border },
  contractTitle: { color: TOKENS.dark.textPrimary },
  installmentBox: { backgroundColor: TOKENS.dark.surface, borderColor: TOKENS.dark.border },
  commentsSidebarDesktop: { backgroundColor: TOKENS.dark.surfaceSubtle, borderLeftColor: TOKENS.dark.borderSubtle },
  commentsTitle: { color: TOKENS.dark.textPrimary },
  commentInputContainer: { backgroundColor: TOKENS.dark.surface, borderColor: TOKENS.dark.border },
  commentInput: { color: TOKENS.dark.textPrimary },
  noCommentsText: { color: TOKENS.dark.textMuted },
  commentDate: { color: TOKENS.dark.textMuted },
  commentCardManual: { backgroundColor: TOKENS.dark.surface, borderColor: '#1e3a8a', borderLeftColor: '#3b82f6', borderLeftWidth: 4 },
  commentTextManual: { color: TOKENS.dark.textPrimary },
  commentCardAuto: { backgroundColor: TOKENS.dark.surface, borderColor: TOKENS.dark.borderSubtle, borderLeftColor: TOKENS.dark.border, borderLeftWidth: 4 },
  commentTextAuto: { color: TOKENS.dark.textSecondary },
  footer: { borderTopColor: TOKENS.dark.borderSubtle, backgroundColor: TOKENS.dark.surface },
  cancelButton: { backgroundColor: TOKENS.dark.surfaceSubtle },
  cancelButtonText: { color: TOKENS.dark.textSecondary },
  successAlertBox: { backgroundColor: TOKENS.dark.surface },
  ...
  pdfNoticeText: { color: TOKENS.dark.textMuted },

  tempBtnInactive: { backgroundColor: TOKENS.dark.surfaceSubtle, borderColor: TOKENS.dark.border },
  tempBtnTextInactive: { color: TOKENS.dark.textSecondary },
  probContainer: { backgroundColor: TOKENS.dark.surfaceSubtle, borderColor: TOKENS.dark.border },
  probJustification: { color: TOKENS.dark.textSecondary },
});